...
#### Deductive Validity
- When it is impossible for all the premises to be true and the conclusion false, the argument is valid
...
- Argument in which a generalization is claimed to be probably true based on information about some members of a particular class
##### Predictive Argument
- A prediction is defended with reasons
